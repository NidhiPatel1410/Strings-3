// In this problem, we are using few variables num, calc, tail, and lastsign. We start iterating over the string, if we find a digit
// we store it in num, then when we find a operator, we do evaluation based on type of operator and store in calc, at last we 
// evaluate and return calc.
